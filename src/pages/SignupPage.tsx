...
function getPasswordStrength(pw: string): PasswordStrength {
  ...
  if (pw.length >= 8 && score >= 1) return 'fair'
  return 'weak'
}
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="bg-card rounded-2xl border border-border shadow-sm p-6 sm:p-8">
          ...
          {error && (
            ...
            >
              <svg className="mt-0.5 h-4 w-4 shrink-0 text-red-500"
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-white px-4 py-2.5
                           text-sm text-text placeholder:text-gray-400 outline-none
              ...
              {password.length > 0 && strengthInfo && (
                <div className="space-y-1 animate-fade-in">
                  <div className="h-1.5 w-full rounded-full bg-gray-100 overflow-hidden">
                    <div
                      className={`h-full rounded-full transition-all duration-400 ${strengthInfo.color} ${strengthInfo.width}`}
                    />
                  </div>
                  <p className="text-xs text-muted-text">
                    ...
                    <span className={`font-medium ${
                      ...
                      strength === 'fair'   ? 'text-amber-600' : 'text-red-500'
                    }`}>
                      {strengthInfo.label}
                    </span>
                  </p>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  disabled={loading}
                  className={`w-full rounded-xl border bg-white px-4 py-2.5 pr-11
                              text-sm text-text placeholder:text-gray-400 outline-none
                ...
                {confirmPassword.length > 0 && (
                  <div className="absolute right-10 top-1/2 -translate-y-1/2 animate-scale-in">
                    {passwordsMatch ? (
                      ...
                      <svg className="h-4 w-4 text-red-400" fill="none"
                           stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round"
            ...
            {/* Terms note */}
            <p className="text-center text-xs text-muted-text leading-relaxed">
              By creating an account you agree to our{' '}
              <a href="#" className="underline underline-offset-2 hover:text-text transition-colors">
                Terms of Service
              </a>{' '}
              and{' '}
              <a href="#" className="underline underline-offset-2 hover:text-text transition-colors">
